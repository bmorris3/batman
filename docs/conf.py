...
project = u'robin'
copyright = u'2018, Brett Morris, Laura Kreidberg'
...
latex_documents = [
  ('index', 'robin.tex', u'robin Documentation',
   u'Laura Kreidberg, Brett Morris', 'manual'),
]
...
man_pages = [
    ('index', 'robin', u'robin Documentation',
     [u'Laura Kreidberg, Brett Morris'], 1)
]
...
texinfo_documents = [
  ('index', 'robin', u'robin Documentation',
   u'Laura Kreidberg, Brett Morris', 'robin', 'One line description of project.',
   'Miscellaneous'),
]
